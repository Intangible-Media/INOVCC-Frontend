...
export default function MapPanel() {
  ...
  const slides = [
    {
      image:
        "https://actonprecast.com/imgs/morphed/7BOUy0d07nVbk99HXw7Q2lRlcTgNEZ.JPG",
    },
    {
      image:
        "https://actonprecast.com/imgs/morphed/7BOUy0d07nVbk99HXw7Q2lRlcTgNEZ.JPG",
        ...
        {currentPanel === "overview" && (
          <div id="overview-content" className="w-full">
            ...
            <div className="flex flex-col border-b px-8 py-6">
              <h4 className="leading-none font-medium text-sm mb-4">Assets</h4>
              <ImageCardSlider slides={slides} />
            </div>
            ...
            <div className="flex flex-col border-b px-8 py-6">
              <div className="flex justify-between">
                <div>
                  ...
                  <select className="block pb-2.5 pt-0 px-0 w-36 text-sm font-medium text-dark-blue-700 bg-transparent border-0 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
        ...
        {currentPanel === "assets" && (
          <div id="assets-content" className="w-full">
            <div className="flex flex-col px-8 py-6">
              <h4 className="leading-none font-medium text-sm mb-2">Assets</h4>
              <div className="grid grid-cols-2 gap-2 ">
                <img
                  src="https://actonprecast.com/imgs/morphed/7BOUy0d07nVbk99HXw7Q2lRlcTgNEZ.JPG"
                  alt=""
                  srcset=""
                />
                <img
