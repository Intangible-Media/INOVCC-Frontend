...
export default function RootLayout({ children }) {
  ...
  const CustomNavbar = () => {
    ...
    return (
      <nav className="fixed top-0 z-50 w-full bg-gray-800 border-b border-blue-950 text-white dark:bg-gray-800 dark:border-gray-700">
        <div className=" mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <div
            className={`md:flex px-4 pt-6 items-center bg-gray-800 fixed z-50 left-0 right-0 bottom-0 top-[64px] transition-opacity duration-300 ease-in-out ${
              isCollapsed ? "opacity-0 pointer-events-none" : "opacity-100"
            }`}
          >
            <SearchBar />
            <ul className="pt-5 space-y-2 font-medium border-gray-300 dark:border-gray-700 w-full md:hidden">
